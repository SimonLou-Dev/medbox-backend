...
Revision ID: 56b761bc6dba
Revises: 
Create Date: 2025-11-25 20:55:01.492292
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'PENDING', 'REJECTED', 'DISABLED', name='userstatus'), nullable=False),
    sa.Column('role', sa.Enum('PATIENT', 'CAREGIVER', 'TENANT_ADMIN', 'GLOBAL_ADMIN', 'DEFAULT', name='userroles'), nullable=False),
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], ondelete='CASCADE'),
    ...
    sa.Column('status', sa.Enum('PENDING', 'CLAIMED', 'EXPIRED', 'CANCELED', name='invitestatus'), nullable=False),
